<template>
  ...
  <div class="app-container">
          ...
          <li
            ...
            <p>{{ video.title }}
              ...
              <span class="acts">
                    ...
                    <el-button style="" type="text" @click="openEditorVideo(video.id)">编辑</el-button>
    ...
    <!-- 添加和修改课时表单 -->
    <el-dialog :visible.sync="dialogVideoFormVisible" :title="title">
